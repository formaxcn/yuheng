                                        ...
                                        <div className="truncate pr-2">
                                            ...
                                            <p className="font-medium text-sm truncate">
                                                {task.status === 'completed'
                                                    ? `${task.result?.length || 0} dishes found`
                                                    : task.status === 'failed' ? 'Recognition failed' : 'Processing...'}
                                            </p>
                                        </div>
                                        <Button
                                            variant="ghost"
                                    ...
                                    <div className="flex items-center gap-3">
                                        {task.status === 'completed' ? (
                                            ...
                                            <div className="flex-1 flex gap-2 items-center min-w-0">
                                                <p className="text-xs text-destructive truncate flex-1">{task.error || 'Unknown error'}</p>
                                                <Button
                                                    size="sm"
                                                    variant="outline"
